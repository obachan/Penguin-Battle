...
am_Project1_OBJECTS = Project1-HelloWorld.$(OBJEXT)
...
builddir = .
bullet_CFLAGS = -I/u/ruoyi/bullet-2.79/include/bullet  
bullet_LIBS = -L/u/ruoyi/bullet-2.79/lib -lBulletSoftBody -lBulletDynamics -lBulletCollision -lLinearMath  
datadir = ${datarootdir}
...
include ./$(DEPDIR)/Project1-HelloWorld.Po
...
Project1-HelloWorld.o: HelloWorld.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Project1_CPPFLAGS) $(CPPFLAGS) $(Project1_CXXFLAGS) $(CXXFLAGS) -MT Project1-HelloWorld.o -MD -MP -MF $(DEPDIR)/Project1-HelloWorld.Tpo -c -o Project1-HelloWorld.o `test -f 'HelloWorld.cpp' || echo '$(srcdir)/'`HelloWorld.cpp
	$(am__mv) $(DEPDIR)/Project1-HelloWorld.Tpo $(DEPDIR)/Project1-HelloWorld.Po
#	source='HelloWorld.cpp' object='Project1-HelloWorld.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Project1_CPPFLAGS) $(CPPFLAGS) $(Project1_CXXFLAGS) $(CXXFLAGS) -c -o Project1-HelloWorld.o `test -f 'HelloWorld.cpp' || echo '$(srcdir)/'`HelloWorld.cpp

Project1-HelloWorld.obj: HelloWorld.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Project1_CPPFLAGS) $(CPPFLAGS) $(Project1_CXXFLAGS) $(CXXFLAGS) -MT Project1-HelloWorld.obj -MD -MP -MF $(DEPDIR)/Project1-HelloWorld.Tpo -c -o Project1-HelloWorld.obj `if test -f 'HelloWorld.cpp'; then $(CYGPATH_W) 'HelloWorld.cpp'; else $(CYGPATH_W) '$(srcdir)/HelloWorld.cpp'; fi`
	$(am__mv) $(DEPDIR)/Project1-HelloWorld.Tpo $(DEPDIR)/Project1-HelloWorld.Po
#	source='HelloWorld.cpp' object='Project1-HelloWorld.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Project1_CPPFLAGS) $(CPPFLAGS) $(Project1_CXXFLAGS) $(CXXFLAGS) -c -o Project1-HelloWorld.obj `if test -f 'HelloWorld.cpp'; then $(CYGPATH_W) 'HelloWorld.cpp'; else $(CYGPATH_W) '$(srcdir)/HelloWorld.cpp'; fi`
